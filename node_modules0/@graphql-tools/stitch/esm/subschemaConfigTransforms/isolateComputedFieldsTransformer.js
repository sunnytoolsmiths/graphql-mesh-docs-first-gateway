import { getNamedType, isCompositeType, isInterfaceType, isObjectType, isScalarType, isUnionType, } from 'graphql';
    ...
    function listReachableTypesToIsolate(subschemaConfig, type, typeNames) {
        ...
        if (isScalarType(type)) {
            ...
            if (isObjectType(type)) {
                ...
                types.push(...getImplementingTypes(type.name, subschemaConfig.schema).map(name => subschemaConfig.schema.getType(name)));
            }
