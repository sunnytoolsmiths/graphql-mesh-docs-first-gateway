...
import type { ServiceDefinition, MessageTypeDefinition } from '@grpc/proto-loader';
    ...
    grpc: {
        reflection: {
            v1alpha: {
                ...
                ServerReflection: SubtypeConstructor<typeof grpc.Client, _grpc_reflection_v1alpha_ServerReflectionClient> & {
