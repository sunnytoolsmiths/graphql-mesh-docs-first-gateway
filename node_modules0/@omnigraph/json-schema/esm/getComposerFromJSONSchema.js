...
export function getComposerFromJSONSchema(schema, logger) {
                            ...
                            if (!existingInputField) {
                                ...
                                */
                                ...
                                if (existingInputFieldUnwrappedTC instanceof InputTypeComposer &&
                                    ...
                                    deepMergeInputTypeComposerFields(existingInputFieldUnwrappedTC.getFields(), newInputFieldUnwrappedTC.getFields());
                                }
                                else {
                                    inputFieldMap[fieldName] = newInputField;
                                }
                            ...
                            if (!existingField) {
                                ...
                                */
                                ...
                                if (existingFieldUnwrappedTC instanceof ObjectTypeComposer &&
                                    ...
                                    deepMergeObjectTypeComposerFields(existingFieldUnwrappedTC.getFields(), newFieldUnwrappedTC.getFields());
                                }
                                else {
                                    fieldMap[fieldName] = newField;
                                }
    ...
    function deepMergeInputTypeComposerFields(existingInputTypeComposerFields, newInputTypeComposerFields) {
        for (const [newFieldKey, newFieldValue] of Object.entries(newInputTypeComposerFields)) {
            ...
            if (!existingFieldValue) {
                ...
                if (existingFieldUnwrappedTC instanceof InputTypeComposer &&
                    ...
                    deepMergeInputTypeComposerFields(existingFieldUnwrappedTC.getFields(), newFieldUnwrappedTC.getFields());
                }
                else {
                    existingInputTypeComposerFields[newFieldKey] = newFieldValue;
                }
    ...
    function deepMergeObjectTypeComposerFields(existingObjectTypeComposerFields, newObjectTypeComposerFields) {
